...
public class MainActivity extends ActionBarActivity {
	...
	public String getIMEINumber() {
		return ((TelephonyManager) getSystemService(Context.TELEPHONY_SERVICE)).getDeviceId().toString();
	}

	public void promptLicenseError() {
		new AlertDialog.Builder(this).setIcon(android.R.drawable.ic_dialog_alert).setTitle("License Error")
