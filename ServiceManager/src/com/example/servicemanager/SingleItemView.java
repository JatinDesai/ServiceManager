...
public class SingleItemView extends ActionBarActivity {
	...
	public void displayServiceHistory() {
		Intent intent = new Intent(getApplicationContext(), com.example.servicemanager.ServiceHistory.class);
	...
	public void resetServiceCount() {
		...
		new AlertDialog.Builder(this).setIcon(android.R.drawable.ic_dialog_alert).setTitle("Reset Services")
				.setMessage("Are you sure you want to Reset Services?")
	...
	public void updateCustomer() {
		Intent intent = new Intent(getApplicationContext(), com.example.servicemanager.NewCustomer.class);
		intent.putExtra(CUSTOMER, customer);
		startActivity(intent);
	}

	public void deleteCustomer() {
		new AlertDialog.Builder(this).setIcon(android.R.drawable.ic_dialog_alert).setTitle("Delete Customer")
